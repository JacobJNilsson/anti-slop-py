...
it. An agent must not edit the spec or any document the work is judged
against. An agent may write a new decision record under `docs/` that
documents what it built.
